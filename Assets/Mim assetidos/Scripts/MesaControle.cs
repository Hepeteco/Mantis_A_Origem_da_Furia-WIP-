...
public class MesaControle : MonoBehaviour {
    ...
    protected bool verificaContato = false;
    ...
    public GameObject setaIndicadoraInicio;
    ...
    private void Start()
    {
         setaIndicadoraInicio.SetActive(true);
        anim = porta.GetComponent<Animator>();
          
    }

    void Update () {
        if (main.ACAO && verificaContato)
           invoca = true;
        if(invoca)
            setaIndicadoraInicio.SetActive(false);
